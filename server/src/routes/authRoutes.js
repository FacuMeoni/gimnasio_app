...
router.post("/register-superadmin", tryCatch(validateSchema(superAdminSchema)), tryCatch(registerSuperAdmin));
router.post("/login", tryCatch(login));
router.post("/register-user", tryCatch(validateSchema(userSchema)), tryCatch(registerUser));
