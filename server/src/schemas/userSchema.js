...
export const superAdminSchema = baseUser.extend({
    role: z.enum(["superadmin"], { required_error: "Role is required", invalid_type_error: "Role must be a string" }).default("superadmin"),
});

export const staffSchema = baseUser.extend({
